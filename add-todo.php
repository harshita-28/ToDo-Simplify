              ...
              <div class="card-body p-4">
                ...
                <form action="" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="e.g. Create a task" value="<?php if (isset($_POST["addTodo"])) { echo $_POST["title"];} ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="desc" class="form-label">Description</label>
                    <textarea class="form-control" id="desc" name="desc" rows="3" required><?php if (isset($_POST["addTodo"])) { echo $_POST["title"];} ?></textarea>
                  </div>
                  <div>
